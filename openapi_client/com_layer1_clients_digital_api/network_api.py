...
class NetworkApi:
    ...
    def get_networks(
        self,
        include_disabled: Annotated[Optional[StrictBool], Field(description="Include disabled networks in the response")] = None,
        ...
        :param include_disabled: Include disabled networks in the response
    ...
    def _get_networks_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/digital/v1/networks',
