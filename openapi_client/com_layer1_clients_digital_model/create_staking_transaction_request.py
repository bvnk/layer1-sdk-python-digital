...
class CreateStakingTransactionRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["assetPoolId", "asset", "network", "type", "reference", "address", "amount", "metadata"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['STAKE', 'UNSTAKE', 'RELEASE', 'unknown_default_open_api']):
            raise ValueError("must be one of enum values ('STAKE', 'UNSTAKE', 'RELEASE', 'unknown_default_open_api')")
        return value
