...
class EstimateTransactionFeeRequest(BaseModel):
    """
    ...
    destinations: Optional[List[Participant]] = Field(default=None, description="(Optional) list of recipient addresses and amounts that benefit from the transaction")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["asset", "network", "sources", "destinations"]
