...
class PaginatedResultAddress(BaseModel):
    """
    ...
    content: Optional[List[Address]] = Field(default=None, description="list of items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [Address.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
