...
class PaginatedResultKeyPair(BaseModel):
    """
    ...
    content: Optional[List[KeyPair]] = Field(default=None, description="list of items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [KeyPair.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
