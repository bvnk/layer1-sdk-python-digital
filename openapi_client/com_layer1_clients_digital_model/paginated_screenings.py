...
from openapi_client.models.screening_view import ScreeningView
from typing import Optional, Set
from typing_extensions import Self

class PaginatedScreenings(BaseModel):
    """
    PaginatedScreenings
    """ # noqa: E501
    total_elements: Optional[StrictInt] = Field(default=None, description="total number of items in all pages", alias="totalElements")
    content: Optional[List[ScreeningView]] = Field(default=None, description="list of items")
    pageable: Optional[Pageable] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["totalElements", "content", "pageable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [ScreeningView.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
