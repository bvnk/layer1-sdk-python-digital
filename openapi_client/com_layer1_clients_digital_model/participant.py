...
class Participant(BaseModel):
    ...
    asset: Optional[StrictStr] = Field(default=None, description="Optional currency if different than in parent object")
    ...
    __properties: ClassVar[List[str]] = ["address", "amount", "asset", "tag"]
