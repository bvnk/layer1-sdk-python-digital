...
class TransactionRequest(BaseModel):
    ...
    TransactionRequest
    """ # noqa: E501
    request_id: Optional[StrictStr] = Field(default=None, description="transaction request id", alias="requestId")
    ...
    status: Optional[StrictStr] = Field(default=None, description="transaction request status")
    sources: Optional[List[Participant]] = Field(default=None, description="requested list of addresses and amounts that fund the transaction")
    destinations: Optional[List[Participant]] = Field(default=None, description="requested list of recipient addresses and amounts that benefit from the transaction")
    type: Optional[StrictStr] = Field(default=None, description="transaction request type")
    created_at: Optional[datetime] = Field(default=None, description="timestamp when transaction request was created", alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, description="timestamp when transaction request was updated", alias="updatedAt")
    failure: Optional[Failure] = Field(default=None, description="failure details")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["requestId", "asset", "assetPoolId", "network", "reference", "status", "sources", "destinations", "type", "createdAt", "updatedAt", "failure"]
