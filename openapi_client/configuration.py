...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "httpSignature": HTTPSignatureAuthSetting,
...
conf = openapi_client.Configuration(
    signing_info = openapi_client.signing.HttpSigningConfiguration(
        ...
        signed_headers =         [openapi_client.signing.HEADER_REQUEST_TARGET,
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.staging.layer1.com" if host is None else host
        """Default Base url
        """
