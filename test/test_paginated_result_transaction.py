...
class TestPaginatedResultTransaction(unittest.TestCase):
    """PaginatedResultTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResultTransaction:
        """Test PaginatedResultTransaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResultTransaction`
        """
        model = PaginatedResultTransaction()
        if include_optional:
    ...
    def testPaginatedResultTransaction(self):
        """Test PaginatedResultTransaction"""
