...
class TestTransactionMetadata(unittest.TestCase):
    """TransactionMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionMetadata:
        """Test TransactionMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionMetadata`
        """
    ...
    def testTransactionMetadata(self):
        """Test TransactionMetadata"""
